            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="side-bar">
                        ...
                        <button onclick="window.location.href='attendance';"><img src="images/group-i.png" alt=""><span>Attendee</span></button>
                    </div>
                </div>
                <div class="col-md-10">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="main-area reg-information" style="display: none;">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="button-area text-center">
                                                                            <a href="order-summary" class="next-btn" id="order-summary">Next</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="main-area order-summary" style="display: none;">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="button-area text-center">
                                                                            <a href="" class="next-btn" id="">Next</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
